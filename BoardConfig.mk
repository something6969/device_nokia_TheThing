DEVICE_PATH := device/nokia/TheThing
BOARD_VENDOR := nokia
...
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/vendor.hmct.factorytest@1.0-service.xml
...
-include vendor/nokia/TheThing/BoardConfigVendor.mk